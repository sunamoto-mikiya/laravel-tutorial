                ...
                <tbody>
                    @foreach ($posts as $post)
                        <tr>
                            <td>{{ $post->id }}</td>
                            <td>{{ $post->title }}</td>
                            <td>{{ $post->is_public ? '公開' : '非公開' }}</td>
                            <td>{{ $post->published_at }}</td>
                            {{-- <td><a class="navbar-brand" href="{{ route('back.personPost', ['id' => $post->user->id]) }}">
                                    {{ $post->user->name }}
                                </a></td> --}}
                            <td>{{ link_to_route('back.user.show', $post->user->name, $post->user->id) }}</td>
                            <td class="d-flex justify-content-center">
                                {{ link_to_route('posts.show', '詳細', $post, [
